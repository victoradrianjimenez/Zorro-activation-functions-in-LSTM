function layer = zlstmLayer(numHiddenUnits, nameValueArgs)
%zlstmLayer   Long Short-Term Memory (LSTM) layer
%
%   layer = zlstmLayer(numHiddenUnits) creates a Long Short-Term Memory
%   layer. numHiddenUnits is the number of hidden units in the layer,
%   specified as a positive integer.
%
%   layer = zlstmLayer(numHiddenUnits, 'PARAM1', VAL1, 'PARAM2', VAL2, ...)
...
%
%       numHiddenUnits = 50;
%       layer = zlstmLayer(numHiddenUnits, 'OutputMode', 'last', ...
...
arguments
    ...
    nameValueArgs.LearnableInitializer = "zeros"
end
...
nameValueArgs.LearnableInitializer = nameValueArgs.LearnableInitializer; %%%%% DO NO CHECK
...
internalLayer = ZLSTMLayerInternal(nameValueArgs.Name, ... %%%%% nnet.internal.cnn.layer.LSTM
    nameValueArgs.InputSize, ...
    numHiddenUnits, ...
    true, ...
    true, ...
    ...
    nameValueArgs.LearnableInitializer ...
    );

% Use the internal layer to construct a user visible layer.
layer = ZLSTMLayerExternal(internalLayer);

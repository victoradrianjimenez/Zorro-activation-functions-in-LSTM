classdef ZBiLSTMLayerExternal < nnet.cnn.layer.BiLSTMLayer
    ...
    methods
        ...
        function out = saveobj(this)
            out = this.saveobj@nnet.cnn.layer.BiLSTMLayer();
...
%             end
            internalLayer = ZBiLSTMLayerInternal( in.Name, ...
                in.InputSize, ...
                in.NumHiddenUnits, ...
                true, ...
                true, ...
            ...
            this = ZBiLSTMLayerExternal(internalLayer);
        end
    end
